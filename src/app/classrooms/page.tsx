            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Rellena los detalles de la nueva aula o laboratorio. Este formulario es un placeholder.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-8 text-center text-muted-foreground">
                      (El formulario para aulas estaría aquí)
                    </div>
                    <DialogFooter>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem>Ver Ocupación</DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem className="text-destructive focus:bg-destructive/10 focus:text-destructive">Eliminar Aula</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </TableCell>
                  </TableRow>
